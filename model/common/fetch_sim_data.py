...
import os
import sys
sys.path.append('repo/pose3d/MTF-Transformer/data/common')
...
def fetch_simdata_frm_scrw(path, sub_list, debug):
    keypoints = {}
    datapath = '../data/RLBench_pose_est_data/2d_wp_to_8d_wp_1_frame_task_0.npz'
    #datapath = '../data/RLBench_pose_est_data/2d_wp_to_8d_wp_1_frame_images_task_0.npz'
...
def main():
    train_actions = []
    r_src = fetch_simdata_frm_scrw('../data/RLBench_pose_est_data', [0], debug=False)
    np.savez('sim_all_formal_waypoints_1_frame_task_0.npz', pose=r_src)
    #np.savez('sim_all_formal_box2d_1_frame_task_0.npz', pose=r_src)
