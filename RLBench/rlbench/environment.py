...
class Environment(object):
    ...
    def __init__(self, action_mode: ActionMode, dataset_root: str='',
                 ...
                 enable_path_observations: bool= True
                 ):
        ...
        self.enable_path_observations = enable_path_observations
    ...
    def get_task(self, task_class: Type[Task]) -> TaskEnvironment:
        ...
        return TaskEnvironment(
            ...
            self._static_positions, self._attach_grasped_objects, enable_path_observations=self.enable_path_observations)
